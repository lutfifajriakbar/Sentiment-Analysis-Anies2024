# -*- coding: utf-8 -*-
"""Skripsi Analisis Sentimen Twitter Anies Baswedan 60:40_Lutfi Fajri Akbar_201910225014.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gnqkjPInwf7DcMQoKsqI8VEbNYDgS3Bd

# **Penerapan Analysis Sentimen Twittter pada Keyword "Elektabilitas Anies" Menggunakan Algoritma Naive Bayes dan SVM**

# **Perbandingan Data Latih dan Data Uji 60:40**
...
x_train, x_test, y_train, y_test = train_test_split(review, label, test_size=0.4)
...
np.savez('sentiment_data_60_40.npz', x_train=x_train, x_test=x_test, y_train=y_train, y_test=y_test)

import numpy as np

# Membaca file .npz
data = np.load('sentiment_data_60_40.npz', allow_pickle=True)
